...
def new_env_file_for_el_cl_genesis_data(
    ...
    return {
        ...
        "Eip7807ForkEpoch": "{0}".format(network_params.eip7807_fork_epoch),
        "Eip7745ForkEpoch": "{0}".format(network_params.eip7745_fork_epoch),
        ...
        "Eip7807ForkVersion": constants.EIP7807_FORK_VERSION,
        "Eip7745ForkVersion": constants.EIP7745_FORK_VERSION,
